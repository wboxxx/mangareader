...
## Configuration Bright Data (optionnel mais recommandé)

Bright Data permet de contourner Cloudflare automatiquement avec des proxies résidentiels.

1. Obtenir votre clé API Bright Data
2. Ajouter la variable d'environnement dans `docker-compose.yml` :
   ```yaml
   environment:
     - BRIGHT_DATA_API_KEY=votre_cle_api_ici
   ```
3. Redémarrer le conteneur

Sans Bright Data, le système utilisera Puppeteer (plus lent, peut ne pas fonctionner avec Cloudflare Turnstile).
